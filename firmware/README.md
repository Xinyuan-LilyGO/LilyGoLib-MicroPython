...
<h1 align = "center">🌟LilyGo MicroPython Firmware🌟</h1>
...
* T-LoRa-Pager does not have a reset button, you must power off and restart to start, otherwise it will always be in download mode
